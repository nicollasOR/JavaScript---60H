async function sendMessage() {
    ...
    const endpoint = "https://juinhosirchat-resource.openai.azure.com/";
    const apiKey = "Av6kVwBbJ2S11c2giEBRsrIiVeXtPJPTxU3hPmvM4UFCNjDSBip6JQQJ99BFACHYHv6XJ3w3AAAAACOGGmW9";
    const deploymentId = "gpt-4o"; // Nome do deployment no Azure OpenAI
    const apiVersion = "2024-04-01-preview"; // Verifique a versão na documentação
